...
class Compartment() : 
    ...
    def __init__(self, id_compartment, config, out_caw_directory, obs_directory) :
        super().__init__() 
    ...
    def defineOutCawPath(self, out_caw_directory, id_compartment):
        """
    ...
    def defineObsCompartment(self, id_compartment, config):
        ...
        if id_compartment in obs_types.keys() : 
            ...
            print(f'Observations has been created')
            return obs
